...
| `planType`    | `enum("plan-purpose aerobic", "plan-purpose high-aerobic", "plan-purpose strength", "plan-purpose speed", "plan-purpose race-speed", "plan-purpose adjust","plan-purpose land")` | /   | 样式选择，根据训练目的选择，详见[](docs/style.css) |
